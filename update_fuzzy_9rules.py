    ...
    "cells": [
        {
            ...
            "source": [
                ...
                "**Inputs:**\n",
                "1. `Age`\n",
                "2. `K-Medoids Cluster Label` (0 = Safe, 1 = Hot, 2 = Core)\n",
                "\n",
                "**Output:**\n",
        ...
        },
        {
            ...
            "source": [
                "# Age ranges\n",
                "age_var['young'] = fuzz.trimf(age_var.universe, [18, 18, 35])\n",
                "age_var['middle'] = fuzz.trimf(age_var.universe, [30, 45, 60])\n",
                "age_var['senior'] = fuzz.trimf(age_var.universe, [55, 86, 86])\n",
                "\n",
                "# K-Medoids Cluster outputs\n",
                "cluster_var['safe'] = fuzz.trimf(cluster_var.universe, [0, 0, 0.5])\n",
                "cluster_var['hot'] = fuzz.trimf(cluster_var.universe, [0.5, 1, 1.5])\n",
                "cluster_var['core'] = fuzz.trimf(cluster_var.universe, [1.5, 2, 2])\n",
                "\n",
        ...
        },
        {
            ...
            "source": [
                ...
                "We define all 9 combinations of (Age x Cluster) to form a complete expert decision matrix."
            ]
        },
        {
            "cell_type": "code",
            ...
            "source": [
                "rules = [\n",
                "    ctrl.Rule(age_var['young'] & cluster_var['safe'], action_score['ignore']),\n",
                "    ctrl.Rule(age_var['young'] & cluster_var['hot'], action_score['target']),\n",
                "    ctrl.Rule(age_var['young'] & cluster_var['core'], action_score['monitor']),\n",
                "    \n",
                "    ctrl.Rule(age_var['middle'] & cluster_var['safe'], action_score['monitor']),\n",
                "    ctrl.Rule(age_var['middle'] & cluster_var['hot'], action_score['target']),\n",
                "    ctrl.Rule(age_var['middle'] & cluster_var['core'], action_score['target']),\n",
                "    \n",
                "    ctrl.Rule(age_var['senior'] & cluster_var['safe'], action_score['ignore']),\n",
                "    ctrl.Rule(age_var['senior'] & cluster_var['hot'], action_score['monitor']),\n",
                "    ctrl.Rule(age_var['senior'] & cluster_var['core'], action_score['monitor'])\n",
                "]\n",
                "\n",
        ...
        },
        {
            ...
            "outputs": [],
            "source": [
                "# Example: A customer who is 45 years old and was assigned to Cluster 1 (Hot Lead) by K-Medoids.\n",
                "fuzzy_sim.input['age'] = 45\n",
                "fuzzy_sim.input['cluster_label'] = 1  # <--- Linked exactly to K-Medoids Output!\n",
                "\n",
                "fuzzy_sim.compute()\n",
...
print('Standalone Fuzzy notebook updated with all 9 rules!')
